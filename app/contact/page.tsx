    ...
    <div>
      ...
      <section id="formulaire" className="bg-[#F5F7FA] px-4 py-12 sm:px-8 sm:py-16 lg:px-20 lg:py-20">
        <div className="mx-auto max-w-[1200px]">
          <h2 className="mb-8 font-title text-2xl font-black uppercase text-[#161A1E] sm:text-3xl">
      ...
      <section className="bg-white px-4 pb-6 pt-14 sm:px-8 sm:pb-8 sm:pt-20 lg:px-20 lg:pb-10 lg:pt-24">
        <FadeIn className="mx-auto max-w-[1200px]">
          ...
          <p className="max-w-[900px] font-ui text-base leading-relaxed text-black/70 sm:text-lg sm:leading-[27px]">
            Installateur RGE basé à Strasbourg, SOLITEK intervient dans toute l'Alsace pour vos projets photovoltaïques, chauffage, climatisation, ventilation et électricité. Une approche locale, humaine et transparente à chaque étape de votre projet.
          </p>
        </FadeIn>
      </section>
      ...
      {[
        {
          ...
          image: "/images/solitek-installation-panneaux-solaires-toiture-alsace-pro.jpg",
        ...
        },
        {
          ...
          image: "/images/solitek-ensoleillement-alsace-panneaux.jpg",
          alt: "Ensoleillement et panneaux solaires en Alsace",
          position: "center",
          reverse: false,
        },
        {
