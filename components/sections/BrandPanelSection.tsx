  ...
  return (
    <footer className="inline-flex h-full w-full flex-col items-start justify-start">
      ...
      <div className="w-full bg-[#161A1E] px-4 sm:px-8 lg:px-[60px]">
        <div className="grid grid-cols-1 divide-y divide-white/10 sm:grid-cols-2 sm:divide-x sm:divide-y-0 lg:grid-cols-4 lg:items-stretch">

          {/* Téléphone */}
          <div className="flex flex-col gap-4 py-8 sm:pr-8 lg:pr-10">
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <a href="tel:+33783289777" className="font-['Figtree'] text-sm font-medium text-white transition-opacity hover:opacity-70">
                +33 7 83 28 97 77
              </a>
            </div>
          </div>
          ...
          {/* Adresse */}
          <div className="flex flex-col gap-4 py-8 sm:px-8 lg:px-10">
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#2DB180]/15">
              <svg className="h-4 w-4 text-[#2DB180]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          <div className="flex flex-col gap-4 py-8 sm:px-8 lg:px-10">
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <p className="font-['Figtree'] text-sm font-medium text-white">Lun - Ven</p>
              <p className="font-['Figtree'] text-xs text-white/60">08h00 - 12h00 / 14h00 - 18h00</p>
            </div>
          </div>

          {/* Activité */}
          <div className="flex flex-col gap-4 py-8 sm:pl-8 lg:pl-10">
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#2DB180]/15">
              <svg className="h-4 w-4 text-[#2DB180]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <p className="font-['Figtree'] text-sm leading-relaxed text-white/80">Photovoltaïque, chauffage, climatisation, ventilation et électricité</p>
              <p className="mt-1 font-['Figtree'] text-xs text-white/40">NAF 43.21A</p>
            </div>
          </div>
